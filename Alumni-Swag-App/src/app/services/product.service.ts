...
products: Product[]= [
  ...
  new Product(3, "OSU Coffee Mug", "All Orange coffee mug with everyones favorite Pistol Pete on the front","https://d3qsmzzpeeacu6.cloudfront.net/all/LXG_CER%20MUG_CER1-ORN-OKSTATE-L1-CLC_1_800x800.jpg"),
